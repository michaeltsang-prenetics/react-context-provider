...
export type ProfileContextType = {
    ...
    createTag: (profileId: string, tag: string, token: string) => Promise<void>;
    updateTag: (profileId: string, tag: string, token: string) => Promise<void>;
    deleteTag: (profileId: string, tagId: string, token: string) => Promise<void>;
    createIdentity: (profileId: string, profileIdentity: Identity, token: string) => Promise<void>;
    updateIdentity: (profileId: string, profileIdentity: ProfileIdentity, token: string) => Promise<void>;
    deleteIdentity: (profileId: string, identityId: string, token: string) => Promise<void>;
